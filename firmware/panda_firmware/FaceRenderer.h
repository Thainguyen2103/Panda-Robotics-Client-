...
static char vietnameseAscii(uint32_t cp) {
  switch (cp) {
    case 0x0110: case 0x0111: return 'd';
    case 0x00C0: case 0x00C1: case 0x00C2: case 0x00C3:
    case 0x0102: case 0x1EA0: case 0x1EA2: case 0x1EA4: case 0x1EA6:
    case 0x1EA8: case 0x1EAA: case 0x1EAC: case 0x1EAE: case 0x1EB0:
    case 0x1EB2: case 0x1EB4: case 0x1EB6:
    case 0x00E0: case 0x00E1: case 0x00E2: case 0x00E3:
    case 0x0103: case 0x1EA1: case 0x1EA3: case 0x1EA5: case 0x1EA7:
    case 0x1EA9: case 0x1EAB: case 0x1EAD: case 0x1EAF: case 0x1EB1:
    case 0x1EB3: case 0x1EB5: case 0x1EB7: return 'a';
    case 0x00C8: case 0x00C9: case 0x00CA: case 0x1EB8: case 0x1EBA:
    case 0x1EBC: case 0x1EBE: case 0x1EC0: case 0x1EC2: case 0x1EC4:
    case 0x1EC6: case 0x00E8: case 0x00E9: case 0x00EA: case 0x1EB9:
    case 0x1EBB: case 0x1EBD: case 0x1EBF: case 0x1EC1: case 0x1EC3:
    case 0x1EC5: case 0x1EC7: return 'e';
    case 0x00CC: case 0x00CD: case 0x0128: case 0x1ECA:
    case 0x1EC8: case 0x00EC: case 0x00ED: case 0x0129:
    ...
    case 0x1EE0: case 0x1EE2: case 0x00F2: case 0x00F3: case 0x00F4:
    case 0x00F5: case 0x01A1: case 0x1ECD: case 0x1ECF: case 0x1ED1:
    ...
    case 0x1EF0: case 0x00F9: case 0x00FA: case 0x0169: case 0x01B0:
    case 0x1EE5: case 0x1EE7: case 0x1EE9: case 0x1EEB: case 0x1EED:
    case 0x1EEF: case 0x1EF1: return 'u';
    case 0x1EF2: case 0x00DD: case 0x1EF4: case 0x1EF6: case 0x1EF8:
    case 0x1EF3: case 0x00FD: case 0x1EF5: case 0x1EF7: case 0x1EF9: return 'y';
    default: return 0;
  }
}

static String displayAscii(const String &text) {
  String out;
  out.reserve(text.length());
  for (size_t i = 0; i < text.length();) {
    uint8_t lead = (uint8_t)text[i++];
    uint32_t cp = lead;
    if ((lead & 0xE0) == 0xC0 && i < text.length()) {
      cp = ((lead & 0x1F) << 6) | ((uint8_t)text[i++] & 0x3F);
    } else if ((lead & 0xF0) == 0xE0 && i + 1 < text.length()) {
      cp = ((lead & 0x0F) << 12) | (((uint8_t)text[i] & 0x3F) << 6) |
    ...
    if (cp < 0x80) out += (char)cp;
      ...
      char mapped = vietnameseAscii(cp);
...
static void drawWrappedText(GFXcanvas16 &g, const String &raw, uint16_t color) {
  String text = displayAscii(raw);
  const int charsPerLine = 27;
  ...
  while (start < (int)text.length() && line < maxLines) {
    ...
    row.trim();
    g.setCursor(max(0, (CANVAS_W - (int)row.length() * 6) / 2), 7 + line * 9);
    g.print(row);
    start = end;
  ...
  if (start < (int)text.length()) {
    g.fillRect(CANVAS_W - 12, CANVAS_H - 8, 3, 3, color);
    g.fillRect(CANVAS_W - 7, CANVAS_H - 8, 3, 3, color);
    g.fillRect(CANVAS_W - 2, CANVAS_H - 8, 2, 3, color);
  }
}
...
static void renderFaceToDisplay(
  ...
  if ((mode == "hearing" || mode == "answering") && text.length() > 0) {
    drawWrappedText(g, text, mode == "answering" ? COLOR_CYAN : COLOR_GREEN);
  } else if (mode == "happy") {
